...
const BUILD_ENV = {
  ...
  TRANSLATION_API_KEY: import.meta.env.TRANSLATION_API_KEY,
  TRANSLATION_MODEL: import.meta.env.TRANSLATION_MODEL,
  TRANSLATION_API_FORMAT: import.meta.env.TRANSLATION_API_FORMAT,
